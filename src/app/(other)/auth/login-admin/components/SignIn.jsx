          ...
          <Col xs={12} sm={10} md={8} lg={5} xl={4}>
            ...
            <div className="text-center mb-4">
              ...
              <p className="text-white mb-0" style={{
                ...
                Acesso para provedores e administradores
              </p>
            </div>
            ...
            <Card className="border-0 shadow-2xl" style={{
              ...
              <CardBody className="p-4 p-md-5">
                ...
                <Alert variant="warning" className="mb-4 border-0" style={{
                  ...
                  <IconifyIcon icon="heroicons:shield-exclamation" className="me-2" />
                  <strong>Área Restrita:</strong> Acesso exclusivo para provedores e administradores do sistema
                </Alert>
                  ...
                  <div className="d-grid mb-4">
                    ...
                    >
                      {loading ? (
                        ...
                        <>
                          <IconifyIcon icon="heroicons:shield-check" width={20} className="me-2" />
                          Acessar Sistema
                        </>
                      )}
                    </button>
            ...
            <div className="text-center mt-4">
              <p className="mb-0" style={{
                ...
                © 2024 Parceirize. Sistema Administrativo.
              </p>
            </div>
          </Col>
        </Row>
