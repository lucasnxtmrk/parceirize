...
export const propertyData = [
  {
    ...
    flor: 0,
    price: '',
    propertyType: 'Serviços',
    country: '',
    type: 'Física',
    variant: '',
    save: true,
    voucher: 'BARBENAVA30', // Voucher combinando nome e desconto
    desconto: '30%'
  },
  {
    id: '2',
    ...
    flor: 0,
    price: '',
    propertyType: 'Alimentação',
    country: '',
    type: 'Física',
    variant: '',
    save: false,
    voucher: 'CAFEAROMA15', // Voucher combinando nome e desconto
    desconto: '15%'
  },
  {
    id: '3',
    ...
    variant: '',
    save: true,
    voucher: 'ACADEMIA25', // Voucher combinando nome e desconto
    desconto: '25%'
  },
  {
    id: '4',
    name: 'Livraria Letras & Saberes',
    location: 'Livraria',
    image: properties4,
    ...
    variant: '',
    save: false,
    voucher: 'LIVRARIA10', // Voucher combinando nome e desconto
    desconto: '10%'
  },
  {
    id: '5',
    name: 'Restaurante Sabores do Mundo',
    ...
    variant: '',
    save: false,
    voucher: 'RESTAURANTE20', // Voucher combinando nome e desconto
    desconto: '20%'
  },
  {
    id: '6',
    name: 'Loja de Roupas Moda & Estilo',
    location: 'Loja de Roupas',
    image: properties6,
    icon: 'solar:home-bold-duotone',
    beds: 0,
    bath: 0,
    ...
    flor: 0,
    price: '',
    propertyType: 'Vestuário',
    country: '',
    type: 'Física',
    variant: '',
    save: true,
    voucher: 'LOJA30', // Voucher combinando nome e desconto
    desconto: '30%'
  },
  {
    id: '7',
    name: 'Salão de Beleza Beleza & Arte',
    ...
    variant: '',
    save: true,
    voucher: 'SALÃO15', // Voucher combinando nome e desconto
    desconto: '15%'
  },
  {
    id: '8',
    ...
    variant: '',
    save: false,
    voucher: 'FARMACIA25', // Voucher combinando nome e desconto
    desconto: '25%'
  },
  {
    id: '9',
    ...
    flor: 0,
    price: '',
    propertyType: 'Alimentos',
    country: '',
    type: 'Física',
    variant: '',
    save: false,
    voucher: 'MERCADO20', // Voucher combinando nome e desconto
    desconto: '20%'
  },
  {
    id: '10',
    ...
    flor: 0,
    price: '',
    propertyType: 'Animais',
    country: '',
    type: 'Física',
    variant: '',
    save: true,
    voucher: 'PETSHOP10', // Voucher combinando nome e desconto
    desconto: '10%'
  }
];
