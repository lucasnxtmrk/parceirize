          ...
          <Col xs={12} sm={10} md={8} lg={5} xl={4}>
            ...
            <div className="text-center mb-4">
              ...
              <p className="text-white mb-0" style={{
                ...
                Gerencie seus parceiros e clientes
              </p>
            </div>
            ...
            <Card className="border-0 shadow-2xl" style={{
              ...
              <CardBody className="p-4 p-md-5">
                ...
                <Alert variant="info" className="mb-4 border-0" style={{
                  ...
                  <IconifyIcon icon="heroicons:building-office" className="me-2" />
                  <strong>Área do Provedor:</strong> Acesso para gestão de empresa e equipe
                </Alert>
                  ...
                  <div className="mb-4">
                    ...
                    <div className="position-relative">
                      ...
                      <TextFormInput
                        control={control}
                        name="email"
                        placeholder="provedor@empresa.com"
                  ...
                  <div className="d-grid mb-4">
                    ...
                    >
                      {loading ? (
                        ...
                        <>
                          <IconifyIcon icon="heroicons:building-office" width={20} className="me-2" />
                          Acessar Painel
                        </>
                      )}
                    </button>
            ...
            <div className="text-center mt-4">
              <p className="mb-0" style={{
                ...
                © 2024 Parceirize. Painel do Provedor.
              </p>
            </div>
          </Col>
        </Row>
